					...
					<div class="col-xl-8 col-6">
						<div class="main-menu">
							<ul class="menu">
								...
								<li><a href="tryusforfree.php"  target="_blank">Try us for Free</a></li>
						...
						<div class="footer-item">
							<div class="footer-quick">
								...
								<ul>
									...
									<li>
										<a href="tryusforfree.php" target="_blank">Try us for free</a>
									</li>
								</ul>
							</div>
						</div>
						...
						<div class="footer-item">
							<div class="footer-quick">
								...
								<ul>
									...
									<li>
										<a href="businesselectronically.php" target="_blank">Terms</a>
									</li>
								</ul>
							</div>
						</div>
